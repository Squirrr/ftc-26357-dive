...
public class Constants {
    ...
    public static class ArmConstants {
        public static final String ELBOW_SERVO_NAME = "saelbow";
        ...
        public static class ExtensionConstants {
            public static final String LEFT_EXTEND_NAME = "lextend";
            ...
            public static final String RIGHT_EXTEND_MOTOR_NAME = "rextend";
    ...
    public static class SpecimenClawConstants {
        public static final String SPEC_CLAW_SERVO_NAME = "specclaw";
    ...
    public static class SampleClawConstants {
        public static final String SAMPLE_CLAW_SERVO_NAME = "samclaw";
        public static final double CLAW_OPEN_CLAW_POS = 1.0;
        public static final double CLAW_CLOSED_CLAW_POS = 0.0;
        public static final String SAMPLE_WRIST_SERVO_NAME = "samwrist";
    }
}
